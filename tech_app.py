...
fig3.add_trace(go.Scatter(x=df.index, y=df['SMA'], name='Middleband',
                         line = dict(color='orange', width=2)))
...
fig3.add_trace(go.Scatter(x=df.index, y=df['200 MA'], name='200 MA',
                         line = dict(color='red', width=2), visible='legendonly'))
...
tab1, tab2, tab3, tab4, tab5 = st.tabs(["Technical Analysis", "Fibonacci Retracements", 'Dow Theory', 'Regression Channels', 'Ichimoku Cloud'])
