...
fig3 = make_subplots(rows=7, cols=1, vertical_spacing = 0.02, subplot_titles=(f"{ticker.upper()} Daily Candlestick Chart", "RSI", "MACD",  "ATR", 'ADX', 'Stochastic Oscillators','Sine Wave'))
...
tab1, tab2, tab3 = st.tabs(['Dow Theory' , "Fibonacci Retracements","Technical Analysis"])
